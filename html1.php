...
<body>
    ...
    <form action="checkhtml.php" method="POST">
        ...
        $q = "select * from question where qid=2 ";
        $query = mysqli_query($con, $q);
        while ($rows = mysqli_fetch_array($query)) {
        ...
        ?>
            ...
            <?php
            $q = "select * from answers where ans_id=2 ";
            $query = mysqli_query($con, $q);
            while ($rows = mysqli_fetch_array($query)) {
        ...
        $q = "select * from question where qid=3 ";
        $query = mysqli_query($con, $q);
        while ($rows = mysqli_fetch_array($query)) {
        ...
        ?>
            ...
            <?php
            $q = "select * from answers where ans_id=3 ";
            $query = mysqli_query($con, $q);
            while ($rows = mysqli_fetch_array($query)) {
            ?>
        ...
        $q = "select * from question where qid=4 ";
        $query = mysqli_query($con, $q);
        while ($rows = mysqli_fetch_array($query)) {
        ...
        ?>
            ...
            <?php
            $q = "select * from answers where ans_id=4 ";
            $query = mysqli_query($con, $q);
            while ($rows = mysqli_fetch_array($query)) {
            ?>
        ...
        $q = "select * from question where qid=5 ";
        $query = mysqli_query($con, $q);
        while ($rows = mysqli_fetch_array($query)) {
